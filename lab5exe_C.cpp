/*
* File Name: lab5Exe_C.cpp
* Assignment: Lab5 Exercise C
* Lab section: (B01)
...
void insertion_sort(const char** a, int n);
...
int main()
{
    ...
    cout << "The value of **z is: " << **z << endl;//X
    cout << "The value of *z is: " << *z << endl;//
    cout << "The value of **(z-1) is: " << **(z-1)<< endl;//A
    cout << "The value of *(z-1) is: " << *(z-1)<< endl;//
    cout << "The value of z[1][1] is: " << z[1][1]<< endl;//Z
    cout << "The value of *(*(z+1)+1) is: " << *(*(z+1)+1)<< endl;//Z
...
void insertion_sort(const char** a, int n)
{
    ...
    for (i = 1; i < n; i++)
    {
        value_to_insert = a[i];
        j = i;
        while (j > 0 && strcmp(a[j-1],value_to_insert)>0)
        {
            a[j] = a[j-1];
            //a[j] = tmp;
            j--;
